...
class ParadaController {
    ...
    static async getParadaByIdRota09ida(req: Request, res: Response): Promise<void> {
        const paradaId = parseInt(req.params.id);
        if (isNaN(paradaId)) {
            res.status(400).json({ message: "ID da parada inválido" });
            return;
    ...
    static async getAllParadasRota09volta(req: Request, res: Response): Promise<void> {
        try {
            const paradas = await ParadaModel.findAllRota09Volta();
            res.status(200).json(paradas);
        } catch (error) {
            console.error(error);
            res.status(500).json({ message: "Internal server error" });
    ...
    static async getParadaByIdRota09volta(req: Request, res: Response): Promise<void> {
        const paradaId = parseInt(req.params.id);
        if (isNaN(paradaId)) {
            res.status(400).json({ message: "ID da parada inválido" });
            return;
    ...
    static async getAllParadasRota10ida(req: Request, res: Response): Promise<void> {
        try {
            const paradas = await ParadaModel.findAllRota10Ida();
            res.status(200).json(paradas);
        } catch (error) {
            console.error(error);
            res.status(500).json({ message: "Internal server error" });
    ...
    static async getParadaByIdRota10ida(req: Request, res: Response): Promise<void> {
        const paradaId = parseInt(req.params.id);
        if (isNaN(paradaId)) {
            res.status(400).json({ message: "ID da parada inválido" });
            return;
    ...
    static async getParadaByIdRota10volta(req: Request, res: Response): Promise<void> {
        const paradaId = parseInt(req.params.id);
        if (isNaN(paradaId)) {
            res.status(400).json({ message: "ID da parada inválido" });
            return;
    ...
    static async getAllParadasRota11ida(req: Request, res: Response): Promise<void> {
        try {
            const paradas = await ParadaModel.findAllRota11Ida();
            res.status(200).json(paradas);
        } catch (error) {
            console.error(error);
            res.status(500).json({ message: "Internal server error" });
    ...
    static async getParadaByIdRota11ida(req: Request, res: Response): Promise<void> {
        const paradaId = parseInt(req.params.id);
        if (isNaN(paradaId)) {
            res.status(400).json({ message: "ID da parada inválido" });
            return;
    ...
    static async getAllParadasRota11volta(req: Request, res: Response): Promise<void> {
        try {
            const paradas = await ParadaModel.findAllRota11Volta();
            res.status(200).json(paradas);
        } catch (error) {
            console.error(error);
            res.status(500).json({ message: "Internal server error" });
    ...
    static async getParadaByIdRota11volta(req: Request, res: Response): Promise<void> {
        const paradaId = parseInt(req.params.id);
        if (isNaN(paradaId)) {
            res.status(400).json({ message: "ID da parada inválido" });
            return;
